...
export default function RightSidebar() {
    ...
    return (
        <div className="flex-shrink-0">
            {!isOpen &&
                <button className="pt-[32px] lg:relative fixed -top-3 right-0 pr-5" onClick={() => { setIsOpen(true) }}>
                    <Image src="/profile-major.svg" width={30} height={30} alt="menu" />
                </button>
            }

            {isOpen &&
                <div className="fixed h-screen right-0 items-stretch overflow-x-hidden bg-white w-[290px] flex flex-col lg:w-[390px] pb-[32px] border-l-[1px] border-[#EAECF0] gap-8">
                    ...
                    <div className="flex flex-col gap-6 px-[25px]">
                        ...
                        <div className="flex flex-col gap-1">
                            <div className="font-semibold text-xl md:text-2xl" >{user.fname} {user.lname}</div>
                            <div className="text-[#475467] text-[16px]" >{user.email}</div>
                        </div>

                        <div className="flex justify-between  items-center">
                            <div className="font-semibold text-base lg:text-lg" >My Banks</div>
                            <Link className="flex gap-3 text-customblue font-semibold  " href="" >
                                <Image src="./plus.svg" width={20} height={20} alt="addicon" />
                                <p className="hidden lg:block" >Add Bank</p>
                            </Link>
                        </div>
                    ...
                    <div className="flex flex-col  border-t-[1px] border-[#EAECF0] gap-6 px-[25px] pt-[24px]">
                        <div className="flex justify-between items-center">
                            ...
                            <button>
                                <Image src="./dots-vertical.svg" width={20} height={20} alt="dropdown" />
                            </button>
                        </div>

                        <div className="flex rounded-xl bg-[#F5FAFF] p-4 gap-[18px]" >
                            <div className="flex flex-col items-center justify-center rounded-[20px] bg-[#D1E9FF] w-[40px] lg:w-[45px] h-[40px]">
                                <Image src="/monitor-04.svg" width={20} height={20} alt="monitor" />
                            </div>
                        ...
                        <div className="flex rounded-xl bg-[#FEF6FB] p-4 gap-[18px]">
                            <div className="flex flex-col items-center justify-center rounded-[20px] bg-[#FCE7F6] w-[45px] h-[40px]">
                                <Image src="/shopping-bag-02.svg" width={20} height={20} alt="monitor" />
                            </div>
                            <div className="flex flex-col gap-[8px] w-full">
                                <div className="flex justify-between">
                        ...
                        <div className="flex rounded-xl bg-[#F6FEF9] p-4 gap-[18px]">
                            <div className="flex flex-col items-center justify-center rounded-[20px] bg-[#D1FADF] w-[45px] h-[40px]">
                                <Image src="/coins-01.svg" width={20} height={20} alt="monitor" />
                            </div>
                            <div className="flex flex-col gap-[8px] w-full">
                                <div className="flex justify-between">
