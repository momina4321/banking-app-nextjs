...
export default function Login(){
    ...
    return <div className="justify-center py-40 flex md:justify-between md:p-0 " >
<div className="flex flex-col justify-center items-center w-1/2 gap-10"> {/*login div   */}
...
<div className="hidden md:flex  bg-[#F3F9FF] pl-40  py-40 w-1/2 justify-end " >
<Image src="/screen-mockup-login.svg" alt="mockup" width={938} height={682} ></Image>
</div>
    </div>
}