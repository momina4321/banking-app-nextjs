...
export default function Register() {
    ...
    return <div className="flex flex-col justify-center py-10 items-center w-1/2 gap-10 "> {/*register container   */}
        <div className="flex flex-col max-w-[500px] gap-10 lg:max-w-[460px] "> {/** login container  */}
...
{validatePassword(password) != "" && <p className="font-medium text-red-600 ">{errors[0]}</p>
            ...
            <div className="flex justify-center gap-1" >
               <p className="hidden md:flex"> Already have an account?</p> <a className="text-[#1A73E9] font-semibold" href="/login">Login</a></div>
        </div>
    </div>
}