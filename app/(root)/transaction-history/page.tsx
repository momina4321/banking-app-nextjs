...
export default function TransactionHistory() {
    ...
    return <div className="   py-[48px] px-[32px]  gap-[32px] flex flex-col w-full ">
        ...
        <div className={`flex flex-col md:flex-row p-[24px] gap-6 border-[1px] text-white rounded-xl ${bank.id === 1 ? "bg-customblue" :
                bank.id === 2 ? "bg-[#039855]" :
                    "bg-[#D9569D]"
            }`} >
        ...
        <div className="flex justify-between items-center " >
            ...
            <div><button className="max-w-[130px]  text-xs lg:text-sm font-semibold px-[10px] py-[16px] border-[#D0D5DD] border-[1px] rounded-lg" >Apply Filter</button></div>
